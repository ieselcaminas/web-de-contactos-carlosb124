 ...
 */
final class Version20251021070942 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        //$this->addSql('ALTER TABLE contacto ADD CONSTRAINT FK_2741493C4E7121AF FOREIGN KEY (provincia_id) REFERENCES provincia (id) ON DELETE SET NULL');
